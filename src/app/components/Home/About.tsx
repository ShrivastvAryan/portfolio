...
export default function AboutSection() {
  return (
    <section
      id="about"
      aria-label="About Aryan Shrivastava"
      className="bg-[#F6F6F6] pt-24 pb-8 xl:py-24 px-6 xl:px-20 font-sans text-[#1A1A1A]"
    >
      <div className="container mx-auto grid grid-cols-1 xl:grid-cols-12 xl:gap-8">
        ...
        <div className="xl:col-span-4 space-y-6 w-full xl:pt-10 flex flex-col items-center xl:items-start mb-8 xl:mb-0 justify-center">
          <ScrollReveal>
            <h2 className="text-5xl md:text-7xl lg:text-8xl xl:text-5xl font-medium tracking-tight">
              About Me
            </h2>
          </ScrollReveal>
