...
export default function PortfolioHero() {
  return (
    <main className="relative  bg-yellow-600 min-h-screen w-full bg-brand-tertiary text-[#1A1A1A] overflow-hidden selection:bg-black selection:text-white">
      ...
      <div className="container mx-auto px-6 lg:px-20 min-h-screen flex flex-col lg:flex-row items-center justify-between pt-20 lg:pt-0">
        ...
        {/* Left Content Column */}
        <div className="w-full lg:w-[50%] z-10 space-y-12 flex flex-col lg:items-start items-center lg:justify-start justify-center">

          {/* Headline */}
          <div className="space-y-4">
            <h1 className="text-[120px] md:text-[180px] leading-[0.8] font-normal tracking-tighter">
              Hello
            </h1>
        ...
        {/* Right Image Column */}
        <div className="w-full lg:w-[50%] relative h-[400px] md:h-[800px] lg:h-screen mt-6 md:mt-0">
          <Image
            src="/removed-bg.png" 
            alt="D.Nova Portrait"
            fill
